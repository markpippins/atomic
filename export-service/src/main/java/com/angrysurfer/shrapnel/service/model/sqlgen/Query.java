...
public class Query {
	...
	private Set< com.angrysurfer.shrapnel.service.model.sqlgen.Column > columns = new HashSet<>();
	...
	private String getTableName(com.angrysurfer.shrapnel.service.model.sqlgen.Column column, boolean prefix) {
