# Angular Throttler Setup Guide

## Network Configuration

### Machine Setup
- **Beryllium** (172.16.30.57):
  - Angular Throttler: Port 3000
...
- **Titanium** (client machine):
  - Browser accessing Angular app

## Configuring Server Profiles in Angular Throttler

The Angular Throttler app needs to be configured with the correct broker URL to connect to the broker gateway on Selenium.

### Option 1: Configure via UI (Recommended)

1. Open the Angular Throttler app at `http://172.16.30.57:3000`
...
Edit `web/angular-throttler-ai/src/services/server-profile.service.ts`:
