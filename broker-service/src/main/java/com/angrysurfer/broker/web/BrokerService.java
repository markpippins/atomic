...
public class BrokerService {
    ...
    private static class MethodKey {
        ...
        public MethodKey(String service, String operation) {
            this.service = service;
            this.operation = operation;
        }
        public String getService() { return service; }
        public String getOperation() { return operation; }
        // Implement equals and hashCode for use in Map
        // (omitted for brevity, but essential for correctness)
    }
    ...
    public ServiceResponse<?> submit(ServiceRequest req) {
        ...
        try {
            ...
            if (result instanceof ServiceResponse<?>) {
                ServiceResponse<?> re = (ServiceResponse<?>) result;
